    ...
    var Toolbar = (function (_super) {
        ...
        Toolbar.prototype.destroy = function () {
            ...
            [].slice.call(btnItems).forEach(function (el) {
                if (!ej2_base_4.isNullOrUndefined(el) && !ej2_base_4.isNullOrUndefined(el.ej2_instances) && !ej2_base_4.isNullOrUndefined(el.ej2_instances[0]) && !(el.ej2_instances[0].isDestroyed)) {
        ...
        Toolbar.prototype.updateTabIndex = function (tabIndex) {
            ...
            if (!ej2_base_4.isNullOrUndefined(ele) && !ej2_base_4.isNullOrUndefined(ele.firstElementChild)) {
        ...
        Toolbar.prototype.eleContains = function (el) {
            return el.classList.contains(CLS_SEPARATOR) || el.classList.contains(CLS_DISABLE) || el.getAttribute('disabled') || el.classList.contains(CLS_HIDDEN) || !ej2_base_2.isVisible(el) || !el.classList.contains(CLS_ITEM);
        };
        ...
        Toolbar.prototype.eleFocus = function (closest, pos) {
            ...
            else if (!ej2_base_4.isNullOrUndefined(closest)) {
        ...
        Toolbar.prototype.clickHandler = function (e) {
            ...
            var popupDownIcon = ej2_base_2.closest(trgt, ('.' + CLS_POPUPDOWN));
            ...
            var isClickBinded = itemObj && !ej2_base_4.isNullOrUndefined(itemObj.click) && typeof itemObj.click == 'object' ?
                !ej2_base_4.isNullOrUndefined(itemObj.click.observers) && itemObj.click.observers.length > 0 :
                !ej2_base_4.isNullOrUndefined(itemObj) && !ej2_base_4.isNullOrUndefined(itemObj.click);
            if (isClickBinded) {
        ...
        Toolbar.prototype.initScroll = function (element, innerItems) {
            if (this.checkOverflow(element, innerItems[0])) {
                ...
                if (this.cssClass) {
                    ej2_base_2.addClass([innerItems[0]], this.cssClass.split(' '));
                }
        ...
        Toolbar.prototype.setOverflowAttributes = function (ele) {
            ...
            ej2_base_2.attributes(this.element.querySelector('.' + CLS_TBARNAV), ariaAttr);
        };
        ...
        Toolbar.prototype.createPopup = function () {
            ...
            var ele;
            var popupPri = [];
            if (ej2_base_3.select('#' + element.id + '_popup.' + CLS_POPUPCLASS, element)) {
                ele = ej2_base_3.select('#' + element.id + '_popup.' + CLS_POPUPCLASS, element);
            }
            else {
        ...
        Toolbar.prototype.popupInit = function (element, ele) {
            if (!this.popObj) {
                ...
                if (this.cssClass) {
                    ej2_base_2.addClass([ele], this.cssClass.split(' '));
                }
        ...
        Toolbar.prototype.checkPriority = function (ele, inEle, eleWidth, pre) {
            ...
            for (var i = len - 1; i >= 0; i--) {
                ...
                if (checkClass(inEle[parseInt(i.toString(), 10)], [CLS_POPPRI]) && popPriority) {
                    ...
                    if (this.isVertical) {
                        ej2_base_3.setStyleAttribute(inEle[parseInt(i.toString(), 10)], { display: 'none', minHeight: eleWid_1 + 'px' });
                    }
                    else {
                        ej2_base_3.setStyleAttribute(inEle[parseInt(i.toString(), 10)], { display: 'none', minWidth: eleWid_1 + 'px' });
                    }
                    itemPopCount++;
                }
                if (this.isVertical) {
            ...
            if (ej2_base_3.selectAll(query, inEle).length === 0) {
                ...
                if ((!ej2_base_4.isNullOrUndefined(eleSep) && checkClass(eleSep, CLS_SEPARATOR) && !ej2_base_2.isVisible(eleSep)) || ignoreCheck) {
                    ...
                    if ((elWid + eleSepWidth) < wid || des) {
                        ...
                        ej2_base_3.setStyleAttribute(el, eleStyles);
        ...
        Toolbar.prototype.ctrlTemplate = function () {
            ...
            innerEle.forEach(function (ele) {
                if (ele.tagName === 'DIV') {
                    ...
                    if (!ej2_base_4.isNullOrUndefined(ele.firstElementChild)) {
        ...
        Toolbar.prototype.enableItems = function (items, isEnable) {
            ...
            if (!ej2_base_4.isNullOrUndefined(len) && len >= 1) {
                ...
                if (isEnable) {
                    ej2_base_2.removeClass(elements, CLS_DISABLE);
                }
                else {
                    ej2_base_2.addClass(elements, CLS_DISABLE);
                }
            }
            else {
            ...
            for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
                ...
                if (this.tbarEle.length >= index && innerItems.length >= 0) {
                    ...
                    if (!this.tbarAlign && itemAgn !== 'Left') {
                        ...
                        this.tbarAlign = true;
                        ele = ej2_base_2.closest(innerItems[0], '.' + CLS_ITEMS).children[parseInt(algIndex.toString(), 10)];
        ...
        Toolbar.prototype.removeItemByIndex = function (index, innerItems) {
            if (this.tbarEle[parseInt(index.toString(), 10)] && innerItems[parseInt(index.toString(), 10)]) {
                ...
                if (!ej2_base_4.isNullOrUndefined(btnItem) && !ej2_base_4.isNullOrUndefined(btnItem.ej2_instances[0]) && !(btnItem.ej2_instances[0].isDestroyed)) {
                    btnItem.ej2_instances[0].destroy();
                }
                ej2_base_2.detach(innerItems[parseInt(index.toString(), 10)]);
        ...
        Toolbar.prototype.templateRender = function (templateProp, innerEle, item, index) {
            ...
            if (typeof (templateProp) === 'string' || !isComponent) {
                ...
                if (item.id) {
                    ...
                    ele.id = ej2_base_4.getUniqueID('tbr-ipt');
                }
                innerEle.appendChild(ele);
                eleObj.appendTo(ele);
            }
            ...
            if (!ej2_base_4.isNullOrUndefined(firstChild)) {
                firstChild.setAttribute('tabindex', ej2_base_4.isNullOrUndefined(firstChild.getAttribute('tabIndex')) ? '-1' : this.getDataTabindex(firstChild));
                firstChild.setAttribute('data-tabindex', ej2_base_4.isNullOrUndefined(firstChild.getAttribute('tabIndex')) ? '-1' : this.getDataTabindex(firstChild));
            }
        ...
        Toolbar.prototype.buttonRendering = function (item, innerEle) {
            ...
            if (item.id) {
                ...
                dom.id = ej2_base_4.getUniqueID('e-tbr-btn');
            }
        ...
        Toolbar.prototype.renderSubComponent = function (item, index) {
            ...
            var tempDom = this.createElement('div', {
                innerHTML: this.enableHtmlSanitizer && !ej2_base_4.isNullOrUndefined(item.tooltipText) ?
                    ej2_base_5.SanitizeHtmlHelper.sanitize(item.tooltipText) : item.tooltipText
            });
            if (!this.tbarEle) {
                this.tbarEle = [];
            }
            ...
            if (item.template) {
                ...
                switch (item.type) {
                    case 'Button':
                        ...
                        dom.setAttribute('tabindex', ej2_base_4.isNullOrUndefined(item.tabIndex) ? '-1' : item.tabIndex.toString());
                        dom.setAttribute('data-tabindex', ej2_base_4.isNullOrUndefined(item.tabIndex) ? '-1' : item.tabIndex.toString());
        ...
        Toolbar.prototype.getDataTabindex = function (ele) {
            return ej2_base_4.isNullOrUndefined(ele.getAttribute('data-tabindex')) ? '-1' : ele.getAttribute('data-tabindex');
        };
        ...
        Toolbar.prototype.activeEleRemove = function (curEle) {
            ...
            if (this.getDataTabindex(this.activeEle) === '-1') {
                if (ej2_base_4.isNullOrUndefined(this.trgtEle) && !curEle.parentElement.classList.contains(CLS_TEMPLATE)) {
                    if (!ej2_base_4.isNullOrUndefined(this.element.querySelector('.e-hor-nav')) && this.element.querySelector('.e-hor-nav').classList.contains('e-nav-active')) {
                        this.updateTabIndex('0');
        ...
        Toolbar.prototype.clearToolbarTemplate = function (templateEle) {
            if (this.registeredTemplate && this.registeredTemplate["" + 'template']) {
                ...
                for (var index = 0; index < registeredTemplates["" + 'template'].length; index++) {
                    ...
                    var closestItem = ej2_base_2.closest(registeredItem, '.' + CLS_ITEM);
                    if (!ej2_base_4.isNullOrUndefined(closestItem) && closestItem === templateEle) {
                ...
                for (var index = 0; index < portals.length; index++) {
                    ...
                    var closestItem = ej2_base_2.closest(portalItem.containerInfo, '.' + CLS_ITEM);
                    if (!ej2_base_4.isNullOrUndefined(closestItem) && closestItem === templateEle) {
                    ...
                    case 'items':
                        if (!(newProp.items instanceof Array && oldProp.items instanceof Array)) {
                            ...
                            for (var i = 0; i < changedProb.length; i++) {
                                ...
                                ej2_base_2.detach(itemCol[parseInt(index.toString(), 10)]);
        ...
        Toolbar.prototype.hideItem = function (index, value) {
            ...
            var eleIndex = index;
            var ele;
            if (!isElement && ej2_base_4.isNullOrUndefined(eleIndex)) {
                return;
            }
            var innerItems = [].slice.call(ej2_base_3.selectAll('.' + CLS_ITEM, this.element));
            if (isElement) {
